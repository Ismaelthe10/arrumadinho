          ...
          <div key={product.id} className={styles.item}>
            <div className={styles.itemTop}>
              ...
              <div className={styles.itemActions}>
                ...
                <button type="button" onClick={() => move(index, 1)} disabled={index === products.length - 1 || savingId !== null} className={styles.iconButton} aria-label="Mover para baixo">
                  <ArrowDownIcon size={16} />
                </button>
                <button type="button" onClick={() => remove(index)} className={styles.iconButtonDanger} aria-label="Remover produto">
                  <TrashIcon size={16} />
                </button>
              </div>
            </div>
